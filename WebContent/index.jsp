...
<style>
	...
	* { margin: 0; padding: 0; }
	...
	.about_area .writing_list > li .img_topwriting { width: 100%; }
           ...
           <div class="about_area">
                ...
                <div class="about_box">
                    <ul class="writing_list box_inner clear">
                        <li><a href="#"><img class="img_topwriting" src="" alt="information"></a><h3>About Taeyeon</h3><p class="txt">Who is she?</p><span class="view">VIEW</span></li>
                        <li><a href="#"><img class="img_topwriting" src="" alt="project1"></a><h3>First Project</h3><p class="txt">What a perfect project!</p><span class="view">VIEW</span></li>
                        <li><a href="#"><img class="img_topwriting" src="" alt="project2"></a><h3>Second Project</h3><p class="txt">Attention, What she did!</p><span class="view">VIEW</span></li>
                    </ul>
                </div>
            </div>
    </div>
